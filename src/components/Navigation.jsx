  ...
  <div className="container mx-auto py-5 flex items-center justify-between px-5">
    ...
    <div className="hidden md:block">
      <ul className="lg:flex gap-5 hidden">
        <li className="text-lg font-bold text-green-400">Home</li>
    ...
    <div className="flex gap-2 md:gap-4 items-center">
      ...
      <button type="button" className="bg-green-400 font-bold text-white rounded py-1 px-3 md:px-4 lg:block hidden">
        CONTACT US
      </button>
      {/* Medium Menu */}
