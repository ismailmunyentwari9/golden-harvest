  ...
  <div className="w-ful contacts py-10">
    <div className="flex lg:flex-row flex-col lg:w-[80%] w-full lg:container mx-auto gap-[5%] py-[2%] bg-black opacity-50 p-12 ">
      <div className="lg:w-1/2 w-full flex justify-center flex-col">
        <h2 className="text-orange-500 text-xl font-bold">GET IN TOUCH WITH US</h2>
        ...
        <form action="POST" className="mt-5">
          ...
          <button type="button" className="bg-orange-400 text-black text-lg  px-3 rounded mt-5">Submit</button>
        </form>
      </div>
      <div className="lg:w-1/2 w-full mt-10">
        <h2 className="text-orange-500 text-xl font-bold">VISIT TEAM GEEK</h2>
        <p className="border-b-4 border-orange-400 pb-5 mb-5 font-thin text-lg">
        ...
        <div className="flex flex-col">
          <p className="flex">
            <span className="fa fa-phone text-orange-400 text-2xl mr-5" />
            <span>
              <p>+971504777204</p>
              <p>+971529155445</p>
              <p>+250788202604</p>
          ...
          <p className="flex mt-5">
            <span className="fas fa-map-marker text-orange-400 text-2xl mr-5" />
            <span>
          ...
          <p className="mt-5">
            <span className="fa fa-envelope text-orange-400 text-2xl mr-5" />
    ...
    <div className="container mx-auto  flex flex-col justify-center opacity-none text w-[80%] mt-10">
      <h2 className="text-orange-500 text-3xl font-bold">Explore and Savor:</h2>
