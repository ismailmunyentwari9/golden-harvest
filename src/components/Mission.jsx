const Mission = () => (
  <div className="mission flex items-center h-[80vh] ">
    <div className="w-[70%]   container mx-auto bg-black flex justify-center flex-col items-center opacity-100 py-10 rounded">
      ...
      <button className="mt-5 bg-green-700 rounded text-[25px] text-black font-bold py-1 px-3  hover:font-normal " type="button">
        Order  Now
