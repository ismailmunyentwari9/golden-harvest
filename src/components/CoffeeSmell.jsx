...
const CoffeeSmell = () => (
  <div className="coffeCap h-[50%] py-[5%]">
    <div className="w-[90%] justify-between flex container mx-auto">
      <div className="lg:w-1/2 md:lg:w-1/2 w-full">
        ...
        <button type="button" className="mt-4 bg-green-700 text-white py-2 px-4 rounded-full font-semibold hover:bg-green-400 transition duration-300">Explore Our Unique Blends</button>
      </div>
    </div>

  </div>
);
export default CoffeeSmell;
